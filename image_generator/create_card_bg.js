 ...
 * Reorders the array so arrows appear at the start (up/left) or end (down/right).
 */
function placeSymbolsInQuarter(doc, layer, symbolsArray, bounds, targetWidth, targetHeight) {
    ...
    // Separate arrows based on direction to enforce list positioning
    ...
    // Combine arrays: [up/left arrows] -> [others] -> [down/right arrows]
